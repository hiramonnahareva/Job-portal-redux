...
const Landing = () => {
  ...
  return (
    <div ref={el} className='h-screen'>
      <div className='max-w-2xl h-[90vh] rounded-t-full absolute top-0 left-1/2 -translate-x-1/2 overflow-hidden z-0'>
        <img
          id='hero1'
          src={hero1}
          alt=''
      ...
      <div className='h-full w-full flex items-center z-10 relative'>
        <div className='flex w-full'>
          <div className='px-20 w-1/2 flex flex-col items-start'>
            ...
            <div
              id='search-container'
              className='bg-white rounded-full p-2 flex w-full max-w-xl overflow-hidden mt-5 shadow-lg'
            >
              <input
          ...
          <div className='flex flex-col justify-between'>
            <div className='statCard rounded-3xl shadow-2xl p-7 bg-white relative left-[50%]'>
              <div>
            ...
            <div className='statCard rounded-3xl shadow-2xl p-7 bg-white relative left-[70%]'>
              <div>
            ...
            <div className='statCard rounded-3xl shadow-2xl p-7 bg-white relative left-[90%]'>
              <div>
