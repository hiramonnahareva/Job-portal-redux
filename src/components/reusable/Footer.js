...
const Footer = () => {
  let date =  new Date().getFullYear();
    return (
     ...
     <footer className="footer grid grid-cols-3 py-20 lg:px-[144px] px-10 gap-3 bg-footer text-white">
  <div className="mr-10">
...
<footer className="footer lg:px-[144px] px-10 py-4 border-t bg-footerb text-white border-gray-800">
